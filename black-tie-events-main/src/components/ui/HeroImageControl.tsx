...
export const HeroImageControl: React.FC<HeroImageControlProps> = ({ value, onChange, onSave, onShowPreview }) => {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="flex flex-row gap-2">
        <Button onClick={handleSave} className="w-fit">Save Image</Button>
